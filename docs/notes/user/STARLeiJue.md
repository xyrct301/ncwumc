---
title: 才不是黑奴呢，只是因为热爱罢了    
createTime: 2025/12/12 12:30:31   
permalink: /STARLeiJue/   
---
<!-- 
title后的XXX是标题
createTime是写作时间
...
<div class="member-card" style="max-width:700px;background:#fff;border-radius:12px;box-shadow:0 5px 20px rgba(0,0,0,0.08);margin:2rem auto;overflow:hidden">
  <div style="background:#2c3e50;padding:25px;display:flex;align-items:center;gap:20px">
    <img src="https://skin.twinklestars.top/avatar/474?size=36" alt="头像" style="width:70px;height:70px;border-radius:50%;border:3px solid #3498db">       <!-- 把XXX换为你的头像链接 -->
    <div>
      <h2 style="color:#fff;margin:0">STARLeiJue</h2>    <!-- 把XXX换为你的ID -->
      <p style="color:#bdc3c7;margin:0">全部ID: STARLeiJue</p>    <!-- 把XXX换为你的ID -->
    </div>
  </div>
  ...
  <div style="flex:0 0 250px;padding:25px;text-align:center;min-width:100%;max-width:100%;box-sizing:border-box">
    <img src="https://skin.twinklestars.top/preview/474?height=150" alt="皮肤" style="max-height:250px;max-width:100%">
  </div>
  ...
  <div>
    ...
    <ul style="list-style:none;padding:0;margin:0">
      <li style="margin:6px 0"><strong>入社时间</strong>：2025.9</li>    <!-- 把XXX换为你的入社时间，如2025.3 -->
      <li style="margin:6px 0"><strong>部门</strong>：技术部</li>         <!-- 把XXX换为你的部门 -->
      <li style="margin:6px 0"><strong>历任职务</strong>：干事</li>         <!-- 把XXX换为你的历任职务 -->
    </ul>
  </div>
  ...
  <div>
    ...
    <p style="line-height:1.6">生电主力，疑似群里最大黑奴（恼</p>           <!-- 把XXX换为你的重要事迹 -->
  </div>
</div>
  </div>
</div>
...
好玩爱玩多玩，有空多找我玩
 ...
 ### 关于画梦
我还没开学就入社了的说，结果过了一年才知道咱画梦居然是正式社团
唉，把我拉进来的人都混成社长了，老大还是太不负责了

 ### 关于社友
大家都好好，都是因为热爱才凑到一块的不是吗
就是一块玩的人疑似有点少了，可能大家都很忙吧